...
​
  ...
  JointAnglePrediction_JOB | Data  | 1_Extracted           | walking/running_meta.h5
                                   ...
                                   | 3_Hyperopt_Results (will be generated by running the scripts)
                                   | 4_Best_Hyperopt (will be generated by running the scripts)
                                   | 5_Optimization (will be generated by running the scripts)
  ```
  But if you have your own preferrence in data structure, please go to the script and modify each path values.
